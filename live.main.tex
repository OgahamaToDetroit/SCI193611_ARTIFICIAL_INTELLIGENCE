...
\begin{enumerate}[label=\alph*.,leftmargin=*]
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\textwidth]{project2/graphs/entropy_large_filter.png}
        \includegraphics[width=0.8\textwidth]{project2/graphs/error_dist_large_filter.png}
        \caption{Uncertainty (top) and Quality (bottom) on the \texttt{large\_filter} layout.}
    \end{figure}
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\textwidth]{project2/graphs/entropy_large_filter_walls.png}
        \includegraphics[width=0.8\textwidth]{project2/graphs/error_dist_large_filter_walls.png}
